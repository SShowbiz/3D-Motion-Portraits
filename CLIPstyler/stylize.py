...
def stylize(args, device=device):
    ...
    show_every = 100
    optimizer = optim.Adam(style_net.parameters(), lr=args.lr_stylize)
    ...
    for epoch in tqdm(range(0, steps + 1)):
        ...
        total_loss = (
            args.lambda_patch * loss_patch + content_weight * content_loss + reg_tv + args.lambda_dir * loss_glob
        )
